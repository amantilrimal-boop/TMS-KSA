  ...
  const menuItems: MenuItem[] = [
    {
      ...
      children: [
        ...
        },
        {
          ...
          subChildren: [
            { href: "/ac-cleaning", label: lang === "ar" ? "تنظيف وصيانة المكيفات" : "AC Cleaning" },
        ...
        {
          href: "/water-pipeline",
          label: lang === "ar" ? "تنظيف خزانات المياه" : "Water Tank & Pipeline Services",
          subChildren: [
...
//{ href: "/pipeline-disinfection", label: lang === "ar" ? "تطهير الأنابيب" : "Pipeline Disinfection" },
        ...
        },
        {
          ...
          subChildren: [
            { href: "/move-in-out-unfurnished", label: lang === "ar" ? "تنظيف المنازل (غير مفروش)" : "Move-In Move-Out Deep Cleaning (Unfurnished)" },
